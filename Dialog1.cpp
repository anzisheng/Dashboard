...
// ============================================
    ...
    m_lineEditPhone->setPlaceholderText("Enter your phone number");
    m_lineEditPhone->setMinimumHeight(25);
    m_lineEditPhone->setInputMethodHints(Qt::ImhDialableCharactersOnly);
