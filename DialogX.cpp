...
bool DialogX::eventFilter(QObject* obj, QEvent* event)
{
...
void DialogX::onLineEditClicked()
{
    ...
    if (!m_dialog) {
        ...
        connect(m_dialog, &QDialog::accepted, this, &DialogX::onDialogAccepted);
    }
